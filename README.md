...
```
📦 프로젝트 루트
├── 컴페티션_서은표.ipynb   # 전체 분석 노트북
├── train2.csv              # 학습 데이터 (Kaggle에서 다운로드)
├── images/                 # 그래프 캡처 이미지 폴더
│   ├── 01_class_distribution.png
│   ├── 02_boxplots.png
│   ├── 03_credit_mix_bar.png
│   ├── 04_correlation_heatmap.png
│   ├── 05_rf_feature_importance.png
│   ├── 06_tabnet_feature_importance.png
...
> 📷 `images/01_class_distribution.png` — 클래스 분포 막대그래프 + 파이차트
...
> 📷 `images/02_boxplots.png` — 등급별 주요 변수(미상환부채, 이자율, 연체일수, 신용이력) Boxplot
...
> 📷 `images/03_credit_mix_bar.png` — Credit_Mix별 Credit_Score 비율 누적 막대그래프
...
> 📷 `images/04_correlation_heatmap.png` — 주요 변수 상관관계 히트맵
...
RandomForest (`n_estimators=120`, `max_depth=14`, `class_weight='balanced_subsample'`)의 `feature_importances_`를 기준으로 **중요도 0.001 미만 변수를 노이즈로 제거**, 최종 **35~55개** 피처 선택

<img width="1969" height="1568" alt="image" src="https://github.com/user-attachments/assets/a07a64c3-2328-462f-9e81-d898edf0b4bd" />
> 📷 `images/05_rf_feature_importance.png` — RandomForest 기반 Feature Importance Top 25
...
> 📷 `images/06_tabnet_feature_importance.png` — TabNet Attention 기반 Feature Importance Top 25
...
> 📷 `images/07_confusion_matrix.png` — Confusion Matrix (Acc 80.76% | Weighted F1 0.8076)
